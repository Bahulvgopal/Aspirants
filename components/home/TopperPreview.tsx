    ...
    <>
      <style>{`
        ...
        .tp-badge {
          ...
          background: #fff0f0; color: #d11215;
        ...
        .tp-page     { flex-shrink: 0; width: 100%; display: grid; gap: 10px; }
        ...
        .tp-arrow {
          ...
          border: 1.5px solid #d11215; background: transparent;
          color: #d11215; cursor: pointer; flex-shrink: 0;
          display: flex; align-items: center; justify-content: center;
          font-size: 1rem;
          transition: background 0.15s, color 0.15s;
          touch-action: manipulation;
        }
        .tp-arrow:hover  { background: #d11215; color: #fff; }
        .tp-arrow:active { background: #d11215; color: #fff; transform: scale(0.94); }
        ...
        .tp-dot::after { content: ''; position: absolute; inset: -8px -4px; }
        .tp-dot.active { background: #d11215; width: 22px !important; }

        .tp-action { text-align: center; margin-top: 1.75rem; }
        .tp-btn {
          display: inline-flex; align-items: center; gap: 8px;
          background: #d11215; color: #fff; text-decoration: none;
        ...
        .tp-btn:hover  { background: transparent; color: #d11215; transform: translateY(-1px); }
        ...
        <div className="tp-container">
          ...
          <div className="tp-viewport">
            ...
            >
              ...
              {/* Clone page 0 for seamless loop */}
              <div
                className="tp-page"
                style={{ gridTemplateColumns: `repeat(${perSlide}, 1fr)` }}
              >
